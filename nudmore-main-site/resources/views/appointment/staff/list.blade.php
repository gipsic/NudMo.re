...
<div class="content-wrapper container">
	<h3>รายการนัดหมายในระบบ <a href="{{ url('/appointment/staff/create/'.'') }}" class="btn btn-success pull-right"><i class="fa-plus fa"></i> เพิ่มรายการนัดหมายใหม่</a></h3>
	<div class="row">
						...
						<table id="datatable2" class="table table-striped table-hover">
							...
							<tbody>
								...
								<tr>
									...
									<td>{!! $appointment->doctor()->first()->doctor_number !!}</td>
									<td>{!! $appointment->doctor()->first()->user()->first()->title !!} {!! $appointment->doctor()->first()->user()->first()->name !!} {!! $appointment->doctor()->first()->user()->first()->surname !!}</td>
