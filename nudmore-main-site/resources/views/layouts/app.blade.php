...
<html lang="en">
    ...
    <body>
                    ...
                    <nav role="navigation" class="navbar topnavbar">
                        ...
                        <div class="nav-wrapper">
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <!-- START Alert menu-->
                                <li>
                                    <a href="{{ url('/profile') }}"><em class="icon-user"></em></a>
                                </li>
                                <!-- END Alert menu-->
                                @endif
                    ...
                    <div class="aside-inner">
                        <nav data-sidebar-anyclick-close="" class="sidebar">
                            ...
                            <ul class="nav">
                                ...
                                <li class=" "><a href="{{ url('/profile') }}" title="ข้อมูลส่วนตัวของคุณ"><em class="icon-user"></em><span>ข้อมูลส่วนตัว</span></a></li>
                                ...
                                <li class=" "><a href="{{ url('/profile/list') }}" title="จัดการผู้ใช้งานระบบ"><em class="icon-people"></em><span>จัดการผู้ใช้งานระบบ</span></a></li>
                                <li class=" "><a href="{{ url('/schedule/staff') }}" title="จัดการตารางออกตรวจ"><em class="fa fa-table"></em><span>จัดการตารางออกตรวจ</span></a></li>
                                <li class=" "><a href="{{ url('/appointment/staff') }}" title="จัดการตารางนัดหมาย"><em class="fa fa-calendar"></em><span>จัดการตารางนัดหมาย</span></a></li>
                                <li class=" "><a href="{{ url('/record/staff') }}" title="จัดการประวัติการรักษา"><em class="fa fa-file-text-o"></em><span>จัดการประวัติการรักษา</span></a></li>
                                <li class=" "><a href="{{ url('/medicine') }}" title="จัดการรายการยา"><em class="fa fa-medkit"></em><span>จัดการรายการยา</span></a></li>
                                <li class=" "><a href="{{ url('/prescription') }}" title="จัดการประวัติการสั่งยา"><em class="fa fa-list-alt"></em><span>จัดการประวัติการสั่งยา</span></a></li>
                                ...
                                <li class=" "><a href="{{ url('/profile/list') }}" title="จัดการผู้ใช้งานระบบ"><em class="icon-people"></em><span>จัดการผู้ใช้งานระบบ</span></a></li>
                                <li class=" "><a href="{{ url('/schedule/doctor') }}" title="จัดการตารางออกตรวจ"><em class="fa fa-table"></em><span>จัดการตารางออกตรวจ</span></a></li>
                                <li class=" "><a href="{{ url('/appointment/doctor') }}" title="จัดการตารางนัดหมาย"><em class="fa fa-calendar"></em><span>จัดการตารางนัดหมาย</span></a></li>
                                <li class=" "><a href="{{ url('/record/staff') }}" title="จัดการประวัติการรักษา"><em class="fa fa-file-text-o"></em><span>จัดการประวัติการรักษา</span></a></li>
                                <li class=" "><a href="{{ url('/prescription/doctor') }}" title="จัดการประวัติการสั่งยา"><em class="fa fa-list-alt"></em><span>จัดการประวัติการสั่งยา</span></a></li>
                               
								@elseif ($current_user->isNurse())
                                <li class="nav-heading "><span>เมนูสำหรับพยาบาล</span></li>
                                <li class=" "><a href="{{ url('/profile/list') }}" title="จัดการผู้ใช้งานระบบ"><em class="icon-people"></em><span>จัดการผู้ใช้งานระบบ</span></a></li>
                                <li class=" "><a href="{{ url('/record/staff') }}" title="จัดการ ประวัติการรักษา"><em class="fa fa-file-text-o"></em><span>จัดการประวัติการรักษา</span></a></li>
                                <li class=" "><a href="{{ url('/prescription') }}" title="จัดการ ประวัติการสั่งยา"><em class="fa fa-list-alt"></em><span>จัดการประวัติการสั่งยา</span></a></li>
                                
								@elseif ($current_user->isPharmacist())
                                <li class="nav-heading "><span>เมนูสำหรับเภสัชกร</span></li>
                                <li class=" "><a href="{{ url('/profile/list') }}" title="จัดการผู้ใช้งานระบบ"><em class="icon-people"></em><span>จัดการผู้ใช้งานระบบ</span></a></li>
                                <li class=" "><a href="{{ url('/record/staff') }}" title="จัดการ ประวัติการรักษา"><em class="fa fa-file-text-o"></em><span>จัดการประวัติการรักษา</span></a></li>
                                <li class=" "><a href="{{ url('/medicine') }}" title="จัดการ รายการยา"><em class="fa fa-medkit"></em><span>จัดการรายการยา</span></a></li>
                                <li class=" "><a href="{{ url('/prescription') }}" title="จัดการ ประวัติการสั่งยา"><em class="fa fa-list-alt"></em><span>จัดการประวัติการสั่งยา</span></a></li>
                                @endif
        ...
        <!-- =============== PAGE VENDOR SCRIPTS ===============-->
        <!-- JQCLOUD-->
        <script src="{{ url('/vendor/jqcloud2/dist/jqcloud.js') }}"></script>
        <!-- Demo-->
