...
<div class="content-wrapper container">
	<h3>ประวัติการรับยาของ {!! $patient->user()->first()->title !!} {!! $patient->user()->first()->name !!} {!! $patient->user()->first()->surname !!} <a href="{{ url('/prescription/doctor/'.$patient->id.'/create') }}" class="btn btn-success pull-right">ออกใบสั่งยาใหม่</a></h3>
	<div class="row">
