        ...
        whenValid: function() {
            ...
            if (l || this.refreshConstraints(), !a || this._isInGroup(a)) {
                ...
                return e.each(u, function(i, n) {
                    ...
                    return d.push(r), "rejected" !== r.state() && void 0
                }), o.all(d)
            }
        },
    ...
    V.prototype = {
        init: function(e) {
            return this.__class__ = "Parsley",
                this.__version__ = "2.4.4", this.__id__ = o.generateID(), this._resetOptions(e), this.$element.is("form") || o.checkAttr(this.$element, this.options.namespace, "validate") && !this.$element.is(this.options.inputs) ? this.bind("parsleyForm") : this.isMultiple() ? this.handleMultiple() : this.bind("parsleyField")
        },
        isMultiple: function() {
